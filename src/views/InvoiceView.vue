  ...
  <div v-if="currentInvoice" class="invoice-view container">
    ...
    <div class="header flex">
      ...
      <div class="right flex">
        ...
        <button @click="deleteInvoice(currentInvoice.id)" class="red">
          Delete
        </button>
        <button
...
export default {
  ...
  methods: {
    ...
    getCurrentInvoice() {
      ...
      // console.log("currentInvoice in InvoiceView", this.currentInvoice);
    },
    ...
    // delete actions - delete from firestore
    async deleteInvoice(id) {
      console.log("deleteInvoice id:", id);
      console.log("deleteInvoice id:", typeof id);
      await this.DELETE_INVOICE_ACTION(id);
      this.$router.push({ name: "Home", replace: true });
    },

    async updateStatusToPaid(id) {
      await this.UPDATE_STATUS_TO_PAID(id);
      this.$router.push({ name: "Home", replace: true });
    },

    async updateStatusToPending(id) {
      await this.UPDATE_STATUS_TO_PENDING(id);
      this.$router.push({ name: "Home", replace: true });
    },
  },
  computed: {
